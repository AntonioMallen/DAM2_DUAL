...
public class AccesoDatos {
	...
	public static boolean insertar(Libro libroInsertar){
		...
		try {
			...
			libro.put("partes", libroInsertar.getPartes());
			libro.put("numero_paginas", libroInsertar.getNumero_paginas());
			libro.put("personajes", libroInsertar.getPersonajes());
		...
		try {
			...
			for (int i = 0 ; i < resultados.size() ; i++) {
				...
				Libro libroObj = new Libro(libro.getInteger("codigo"),libro.getString("titulo"),
						...
						,libro.getList("partes",String.class),libro.getInteger("numero_paginas"),libro.getList("personajes",String.class));
