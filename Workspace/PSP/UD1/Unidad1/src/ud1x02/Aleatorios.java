...
public class Aleatorios {
	...
	public static void main (String []args) {
		...
		ProcessBuilder pb = new ProcessBuilder("java", "ud1x02/GeneraAleatorio");
		pb.directory(directorio); // le decimos que directorio usar, en este caso es la carpeta bin(donde se guardan archivos ya compilados)
		Process hijo;
		try{
			hijo= pb.start();
